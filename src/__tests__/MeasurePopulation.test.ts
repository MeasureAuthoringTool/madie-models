...
describe("MeasureScoring Model", () => {
  it("Verifies that MeasurePopulation has the correct attributes", () => {
    ...
    expect(PopulationType.DENOMINATOR_EXCLUSION).toEqual("denominatorExclusion");
    expect(PopulationType.DENOMINATOR_EXCEPTION).toEqual("denominatorException");
    ...
    expect(PopulationType.DENOMINATOR_OBSERVATION).toEqual("denominatorObservation");
    expect(PopulationType.NUMERATOR_OBSERVATION).toEqual("numeratorObservation");
  });
});
